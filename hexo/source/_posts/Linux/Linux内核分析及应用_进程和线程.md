...
![image-20220414230607715](image-20220414230607715.png)
...
![image-20220414230655461](image-20220414230655461.png)
...
![image-20220414230721994](image-20220414230721994.png)
...
![image-20220414231302749](image-20220414231302749.png)
...
![image-20220414231611373](image-20220414231611373.png)
...
![image-20220414231726986](image-20220414231726986.png)

注意fork和vfork最终都调用do_fork函数，只是传入的clone_flags参数不同而已，参见表1-1。

![image-20220414231752340](image-20220414231752340.png)

因为进程创建的核心就是do_fork函数，所以来看一下它的相关参数：

![image-20220414231858118](image-20220414231858118.png)
...
![image-20220414232022719](image-20220414232022719.png)
...
![image-20220414232140662](image-20220414232140662.png)
...
![image-20220414232427224](image-20220414232427224.png)

handle_mm_fault最终会调用handle_pte_fault，其主要代码如下：

![image-20220414232445872](image-20220414232445872.png)

即在缺页异常中，如果遇到写保护，则会调用do_wp_page，这里面会处理上面所说的写时复制中父子进程区分的问题。最后通过图1-8来说明fork和vfork在地址空间分配上的区别。

![image-20220414232506479](image-20220414232506479.png)

#### 2．进程栈的分配

copy_process中另一个比较重要的函数就是copy_thread_tls，在创建子进程的过程中，进程的内核栈空间是随进程同时分配的，结构如图1-9所示。代码如下：

![image-20220414232533485](image-20220414232533485.png)

![image-20220414232548773](image-20220414232548773.png)

其中，task_pt_regs(p)的代码如下：

![image-20220414232600829](image-20220414232600829.png)
