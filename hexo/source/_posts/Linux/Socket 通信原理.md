...
​     TCP/IP（Transmission Control Protocol/Internet Protocol）即**传输控制协议/网间协议**，是一个工业标准的协议集，它是为广域网（WANs）设计的。
...
在图1中，我们没有看到Socket的影子，那么它到底在哪里呢？还是用图来说话，一目了然。![img](https://images.cnblogs.com/cnblogs_com/goodcandle/socket2.jpg)

### 3. **Socket**是什么呢？

​	Socket是**应用层与TCP/IP协议族通信的中间软件抽象层，它是一组接口**。在设计模式中，Socket其实就是一个门面模式，它把复杂的TCP/IP协议族隐藏在Socket接口后面，对用户来说，一组简单的接口就是全部，让Socket去组织数据，以符合指定的协议。
...
![Socket通信原理和实践 <wbr>(转)](https://img-my.csdn.net/uploads/201302/10/1360431052_7481.png)
