...
![image-20220427152410287](image-20220427152410287.png)
...
![image-20220427152437404](image-20220427152437404.png)
...
![image-20220427152527250](image-20220427152527250.png)
...
![image-20220427152601920](image-20220427152601920.png)

在ext4_iget初始化inode的时候会进行注册：

![image-20220427152620993](image-20220427152620993.png)

然后在vfs_open打开文件的时候调用了do_dentry_open：

![image-20220427152638685](image-20220427152638685.png)

至此彻底搞清楚了，ext4的read和write文件最终委托给了：

![image-20220427152655324](image-20220427152655324.png)
...
![image-20220427153037223](image-20220427153037223.png)