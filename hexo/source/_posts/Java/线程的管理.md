...
1. 分时调度模型：系统平均分配CPU的时间片，所有线程轮流占用CPU，即在时间片调度的分配上所有线程“人人平等”。图1-10所示是一个分时调度的简单例子，三个线程轮流得到CPU时间片，一个线程执行时，另外两个线程处于就绪状态。
   ...
   ![image-20220411231219434](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220411231219434.png)
...
在Thread类中有一个实例属性和两个实例方法，专门用于进行线程优先级相关的操作。与线程优先级相关的成员属性为：![image-20220412103843814](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412103843814.png)
...
![image-20220412103859878](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412103859878.png)
...
![image-20220412105656984](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412105656984.png)

Thread类用于获取线程状态的实例方法为：

![image-20220412105714696](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412105714696.png)

Thread.State是一个内部枚举类，定义了6个枚举常量，分别代表Java线程的6种状态，具体如下：

![image-20220412105733071](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412105733071.png)
...
![image-20220412105831150](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412105831150.png)
...
![image-20220412141716434](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412141716434.png)

### 1.线程的join操作的三个版本

join()方法是Thread类的一个实例方法，有三个重载版本：

![image-20220412141734969](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412141734969.png)
...
![image-20220412144746644](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412144746644.png)
...
![image-20220412145823830](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412145823830.png)
...
![image-20220412145803334](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412145803334.png)
...
![image-20220412145946599](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412145946599.png)
...
![image-20220412150253473](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412150253473.png)
...
![image-20220412150331349](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412150331349.png)

2. 实例方法setDaemon(…)：此方法将线程标记为守护线程或者用户线程。setDaemon(true)将线程设置为守护线程，setDaemon(false)将线程设置为用户线程。

   ![image-20220412150404472](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412150404472.png)

3. 实例方法isDaemon()：获取线程的守护状态，用于判断该线程是不是守护线程。

![image-20220412150415956](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412150415956.png)
...
![image-20220412150736413](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412150736413.png)
...
![image-20220412150956890](%E7%BA%BF%E7%A8%8B%E7%9A%84%E7%AE%A1%E7%90%86/image-20220412150956890.png)
