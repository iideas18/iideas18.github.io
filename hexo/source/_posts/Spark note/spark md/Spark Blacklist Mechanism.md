...
- [前言](https://www.turbofei.wang/spark/2019/08/30/Spark-Blacklist-Mechanism-Introduction#前言)
- BlackList机制
  - [BlackList级别](https://www.turbofei.wang/spark/2019/08/30/Spark-Blacklist-Mechanism-Introduction#blacklist级别)
  - [FetchFailure & BlackList](https://www.turbofei.wang/spark/2019/08/30/Spark-Blacklist-Mechanism-Introduction#fetchfailure--blacklist)
  - [Yarn Node launch Failure](https://www.turbofei.wang/spark/2019/08/30/Spark-Blacklist-Mechanism-Introduction#yarn-node-launch-failure)
- [BlackList 参数](https://www.turbofei.wang/spark/2019/08/30/Spark-Blacklist-Mechanism-Introduction#blacklist-参数)
