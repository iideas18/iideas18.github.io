...
cover: "https://ask.hellobi.com/uploads/article/20161221/945471998ade1467cb50c14bcead2c5b.png"
slug: "Inceptor任务的图形化"
categories:
  - "Spark note"
  - "spark md"
...
# [技术|Inceptor任务的图形化分析（一）](https://ask.hellobi.com/blog/transwarp/5748)

发表: 2016-12-22 浏览: 785

[大数据](https://ask.hellobi.com/topic/大数据)
...
​                       ![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/945471998ade1467cb50c14bcead2c5b.png)
...
Cluster页是对各Stage运行情况的宏观描述，描述内容主要涵盖了以下9个基本信息：
  ...
  ![表.png](https://ask.hellobi.com/uploads/article/20161222/2c41743a3a03c0eab9624b217f411ec1.png)
...
![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/5577ea579e9fecbdaeb920c9ea432d0b.png)
...
![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/cc4e49b1abd2a570cf8867e08c92e682.png)
...
![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/0827c9eac005f1dddfc5400dca067fd8.png)

从提供的失败原因可以知道该Stage的失败是因为ID为4300的Stage被kill掉，而导致后续相关Task都无法执行。

除了以上三种Stage的信息描述，Cluster页面还在页面左上角分别给出了这三类Stage的当前数量。如下图所示：

![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/157c81e3b620c3ed88e6d83475359044.png)
...
![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/5d550afcac82ca9b0f89e54b7bf8ec98.png)

进入该页面后，用户还可通过位于该页面左上角的DAG Visualization按钮获得当前Job的DAG。

![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/dbd3579f17a11a4cdc38e2831b83fd64.png)

DAG是表达各个RDD之间转换的关系的有向无环图，图形化的描述了各个操作符之间的传递顺序，直观的反映了Job执行的全过程。我们可以通过分析DAG，明确每一个Stage的任务内容，对于复杂的语句可以帮助锁定到出现性能问题的环节。

例如，对于如下语句：

![1.1表.png](https://ask.hellobi.com/uploads/article/20161222/ff9edf4f7312d7daab94b20b6b106a12.png)
...
![Clipboard Image.png](https://ask.hellobi.com/uploads/article/20161221/53a5c9d0d62740d25243911c8be23193.png)
...
# [技术|Inceptor任务的图形化分析（二）](https://ask.hellobi.com/blog/transwarp/5807)

发表: 2016-12-29 浏览: 959
...
![img](https://ask.hellobi.com/uploads/article/20161229/2005d773306018aa6ac895a02eacd593.png)
...
​    ![img](https://ask.hellobi.com/uploads/article/20161229/978fef82f567294e5a75c4c3940a2395.png)

进入表的链接后可以看到对应表的各个Block的存放位置和大小。例如，点击进入第二行tpcds_holodesk_2.customer_address表的信息描述界面，如下图所示：

   ![img](https://ask.hellobi.com/uploads/article/20161229/a8f09d304e08dbee4274b4558860941c.png)
...
​                              ![img](https://ask.hellobi.com/uploads/article/20161229/e2ab978e14834f36cbfec598263e3a01.png)

例如，某一集群的Executors页面的列表如下图所示：

   ![img](https://ask.hellobi.com/uploads/article/20161229/94413bf80defac5a37a11977994071b6.png)
...
# [技术|Inceptor任务的图形化分析（三）](https://ask.hellobi.com/blog/transwarp/5828)

发表: 2017-01-03 浏览: 954
...
![img](https://ask.hellobi.com/uploads/article/20170103/a07962677fadd534d0fc22025fda1249.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/ba34a765ad01b1b7462df333917ad53f.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/691315053478def8258e106d7c6d7f1f.png)

该表中的各字段含义和字面意思一致，除去同Shuffle Spill相关的两列，其余列的含义和已介绍的Executors列表中列值代表意义相同（参考[技术|Inceptor任务的图形化分析（二）](https://ask.hellobi.com/blog/transwarp/5807)）。Shuffle Spill(Memory)和Shuffle Spill(Disk)分别代表在实现Shuffle时中写入内存和硬盘的数据量，对调优帮助不大，读者可以忽略。

- **Tasks**

Tasks列表的示例如下图所示：

![img](https://ask.hellobi.com/uploads/article/20170103/7885cd0a4fef1602cbacaf09a56f2a3e.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/f283106b3d07107085d4e1fca78cae01.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/d62501f050b6545a3ea73eb626f8de74.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/8b3cfa86c0317e6866e29b20cb23fe02.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/7ee6dc4faeac247105d57cd942ff8cfb.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/283296e3a75ce12872594a37e406be6b.png)
...
![img](https://ask.hellobi.com/uploads/article/20170103/692a18ed04cce8e7f0dae250b1b61d1b.png)
